...
-- Records of tb_paper
-- ----------------------------
INSERT INTO `tb_paper` VALUES ('1', 'a', '2018-05-01 11:27:40', '2018-05-14 11:27:43', 'sa', '1', '32', 'true', '1');
INSERT INTO `tb_paper` VALUES ('2', 'b', '2018-05-08 14:41:56', '2018-06-27 14:42:00', 'sasadfwe', '233', '213', 'false', '2');
INSERT INTO `tb_paper` VALUES ('3', 'fwefew', '2018-06-04 13:44:23', null, '<h1>Some initial content</h1>', '1', '1', 'false', '3');
INSERT INTO `tb_paper` VALUES ('4', 'Vue????', '2018-06-04 14:51:58', null, '<h1>                                                                    Vue????</h1><h1><br></h1><h1>??</h1><p class=\"ql-align-justify\">????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????</p><p class=\"ql-align-justify\">????????????????1. MTBF (Mean Time Between Failure) ????????????2. MTTR (Mean Time To Recovery) ?????????????????????????????????????????“??9”?</p><p class=\"ql-align-justify\"><img src=\"https://user-gold-cdn.xitu.io/2018/6/1/163b9288052d2865\" alt=\"?????\"></p><p class=\"ql-align-justify\">??????????????????????????????????????????????</p><h1>1. ????</h1><p class=\"ql-align-justify\">???????????????????????????????????????????????????????????</p><p class=\"ql-align-justify\">?????????????????????????????????????????????????????????????App?PC?M????????????????????????????/QQ/??????????????????????????????????????App??????????????Referer????????????????????????????????</p><p class=\"ql-align-justify\">?????????????????????????????????????????????????????ElasticSearch??????????????</p><h1><br></h1>', '1', '1', 'false', '4');
INSERT INTO `tb_paper` VALUES ('5', '??', '2018-06-04 14:57:55', null, '<h1>??</h1><p class=\"ql-align-justify\">????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????</p><p class=\"ql-align-justify\">????????????????1. MTBF (Mean Time Between Failure) ????????????2. MTTR (Mean Time To Recovery) ?????????????????????????????????????????“??9”?</p><h1><br></h1><h1><br></h1><h1><br></h1>', '1', '1', 'false', '1');
INSERT INTO `tb_paper` VALUES ('6', '??2', '2018-06-04 15:09:49', null, '<h1>??</h1><p class=\"ql-align-justify\">????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????</p><p class=\"ql-align-justify\">????????????????1. MTBF (Mean Time Between Failure) ????????????2. MTTR (Mean Time To Recovery) ?????????????????????????????????????????“??9”?</p><h1><br></h1>', '1', '1', 'false', '2');
INSERT INTO `tb_paper` VALUES ('7', '??2', '2018-06-04 15:12:17', null, '<h1>??</h1><p class=\"ql-align-justify\">????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????</p><p class=\"ql-align-justify\">????????????????1. MTBF (Mean Time Between Failure) ????????????2. MTTR (Mean Time To Recovery) ?????????????????????????????????????????“??9”?</p><h1><br></h1>', '1', '1', 'false', '1');
...
-- ----------------------------
INSERT INTO `tb_paper_type` VALUES ('1', '数据库');
INSERT INTO `tb_paper_type` VALUES ('2', 'Java');
INSERT INTO `tb_paper_type` VALUES ('3', '网络安全');
INSERT INTO `tb_paper_type` VALUES ('4', '爬虫');
